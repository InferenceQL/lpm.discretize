...
def test_discretize_df():
    ...
    assert discretized_df.frame_equal(df_expected)
...
def test_discretize_df_non_mutable():
    ...
    assert not discretized_df.frame_equal(df)
...
def test_discretize_df_null_op(df_args):
    ...
    assert discretized_df.frame_equal(df)
...
def test_discretize_df_supplying_quantiles():
    ...
    assert discretized_df.frame_equal(_df_expected)
...
def test_discretize_df_quantiles_non_mutable():
    ...
    assert not discretized_df.frame_equal(_df_input)
...
def test_discretize_quantiles_spot_check_int_quartiles():
    ...
    assert discretized_dfs[0].frame_equal(expected[0])
    assert discretized_dfs[1].frame_equal(expected[1])
